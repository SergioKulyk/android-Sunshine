...
public class MainActivity extends AppCompatActivity {
    ...
    private class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        protected String[] doInBackground(String... params) {
            ...
            URL urlWeatherLocation = NetworkUtils.buildUrl(location);

            try {
                String jsonWeatherResponse =
                        NetworkUtils.getResponseFromHttpUrl(urlWeatherLocation);

                String[] simpleJsonWeatherFormat =
                        OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(MainActivity.this, jsonWeatherResponse);

                return simpleJsonWeatherFormat;
            } catch (Exception e) {
                e.printStackTrace();
                return null;
            }
